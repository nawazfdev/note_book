    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <div class="text-center py-5">
                ...
                <h3 class="text-muted mb-3">Note Editing Coming Soon</h3>
                <p class="text-muted mb-4">The note editing feature is being developed. You can create new notes for now!</p>
